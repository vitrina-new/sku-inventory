...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request payload for updating an existing SKU")
public class SkuUpdateRequest {
    ...
    @Schema(description = "Product category code", example = "LBR")
    ...
    @Schema(description = "SKU status", example = "ACTIVE", allowableValues = {"ACTIVE", "DISCONTINUED", "SEASONAL"})
    @Pattern(regexp = "^(ACTIVE|DISCONTINUED|SEASONAL)$", message = "Status must be ACTIVE, DISCONTINUED, or SEASONAL")
